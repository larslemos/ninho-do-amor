        ...
        <>
            {showAddModal && (
                <div className="fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 duration-300 animate-in">
                    <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
                        <div className="p-6">
                            <h3 className="mb-4 font-josefin text-lg font-semibold text-gray-900">Adicionar Novo Convidado</h3>
                            <div className="space-y-4">
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Nome Completo</label>
                                    <input
                                        type="text"
                                        value={newGuest.nome}
                                ...
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Telefone</label>
                                    <input
                                        type="tel"
                                ...
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Email (opcional)</label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Mesa (opcional)</label>
                                    <input
                                        type="text"
                                        value={newGuest.mesa}
            ...
            {showEditModal && editGuest && (
                <div className="fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 duration-300 animate-in">
                    <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
                        <div className="p-6">
                            <h3 className="mb-4 font-josefin text-lg font-semibold text-gray-900">Editar Convidado</h3>
                            <div className="space-y-4">
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Nome Completo</label>
                                    <input
                                        ...
                                        onChange={(e) => setEditGuest({ ...editGuest, nome: e.target.value } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                        placeholder="Ex: João Silva"
                                        required
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setEditGuest({ ...editGuest, telefone: e.target.value } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                        placeholder="Ex: +258 84 123 4567"
                                        required
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setEditGuest({ ...editGuest, email: e.target.value } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                        placeholder="Ex: joao@example.com"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setEditGuest({ ...editGuest, mesa: e.target.value } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                        placeholder="Ex: Mesa 5"
                                    />
                                </div>
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Status</label>
                                    <select
                                        value={editGuest.status}
                                        onChange={(e) => setEditGuest({ ...editGuest, status: e.target.value as 'pending' | 'confirmed' | 'rejected' } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                    >
                                ...
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Convite Enviado (opcional)</label>
                                    <input
                                        type="datetime-local"
                                        value={formatDateForInput(editGuest.invitation_sent_at)}
                                        onChange={(e) => setEditGuest({ ...editGuest, invitation_sent_at: e.target.value ? new Date(e.target.value).toISOString() : null } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                    />
                                </div>
                                <div>
                                    <label className="mb-1 block font-quicksand text-sm font-medium text-gray-700">Prazo RSVP (opcional)</label>
                                    <input
                                        type="datetime-local"
                                        value={formatDateForInput(editGuest.rsvp_deadline)}
                                        onChange={(e) => setEditGuest({ ...editGuest, rsvp_deadline: e.target.value ? new Date(e.target.value).toISOString() : null } as Guest)}
                                        className="w-full rounded-lg border border-gray-300 px-3 py-2 font-quicksand focus:border-rose-500 focus:ring-2 focus:ring-rose-500"
                                    />
                                </div>
                            </div>
            ...
            {showDeleteModal && guestToDelete && (
                <div className="fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 duration-300 animate-in">
                    <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
                        <div className="p-6">
                            <h3 className="mb-4 font-josefin text-lg font-semibold text-gray-900">Confirmar Exclusão</h3>
