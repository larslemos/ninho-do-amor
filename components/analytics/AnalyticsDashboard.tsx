...
import { TrendingUp, TrendingDown, Users, Calendar, DollarSign, Camera, Mail, AlertTriangle, Download, Filter, RefreshCw, Eye, Heart, MessageSquare, Clock, CheckCircle, XCircle, MapPin, Phone, Utensils } from 'lucide-react'
  ...
  const mockAnalytics = {
    ...
    trends: {
      ...
      engagementTrend: [
        ...
        { date: '2025-01-21', visits: 156, uniqueVisitors: 112, pageViews: 623 }
      ],
      budgetTrend: [
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Insights detalhados do seu casamento</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <button className="flex items-center gap-2 bg-rose-600 hover:bg-rose-700 text-white px-4 py-2 rounded-lg transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs mt-2 opacity-75">
                        {new Date(alert.createdAt).toLocaleDateString('pt-MZ')} às {new Date(alert.createdAt).toLocaleTimeString('pt-MZ', { hour: '2-digit', minute: '2-digit' })}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">{analytics.overview.totalGuests}</p>
                    <div className="flex items-center gap-1 mt-2">
                      {getChangeIcon(12)}
                      <span className={`text-sm font-medium ${getChangeColor(12)}`}>+12 esta semana</span>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Taxa de Resposta</p>
                    <p className="text-3xl font-bold text-gray-900">{analytics.overview.responseRate}%</p>
                    <div className="flex items-center gap-1 mt-2">
                      {getChangeIcon(5)}
                      <span className={`text-sm font-medium ${getChangeColor(5)}`}>+5% este mês</span>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Visitas ao Site</p>
                    <p className="text-3xl font-bold text-gray-900">{analytics.overview.websiteVisits}</p>
                    <div className="flex items-center gap-1 mt-2">
                      {getChangeIcon(234)}
                      <span className={`text-sm font-medium ${getChangeColor(234)}`}>+234 esta semana</span>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-600 text-sm font-medium">Orçamento Usado</p>
                    <p className="text-3xl font-bold text-gray-900">
                      {Math.round((analytics.overview.spentAmount / analytics.overview.totalBudget) * 100)}%
                    </p>
                    <div className="flex items-center gap-1 mt-2">
                      <span className="text-sm text-gray-600">
                        {formatCurrency(analytics.overview.spentAmount)} de {formatCurrency(analytics.overview.totalBudget)}
                      </span>
                    </div>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={analytics.trends.rsvpTrend}>
                    ...
                    <XAxis dataKey="date" tickFormatter={(value) => new Date(value).toLocaleDateString('pt-MZ', { month: 'short', day: 'numeric' })} />
                    <YAxis />
                    <Tooltip 
                      labelFormatter={(value) => new Date(value).toLocaleDateString('pt-MZ')}
                      formatter={(value, name) => [value, name === 'confirmed' ? 'Confirmados' : name === 'pending' ? 'Pendentes' : 'Rejeitados']}
                    />
                    <Legend />
              ...
              {/* Engagement Trend */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Engagement do Site</h3>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={analytics.trends.engagementTrend}>
                    ...
                    <Tooltip 
                      labelFormatter={(value) => new Date(value).toLocaleDateString('pt-MZ')}
                      formatter={(value, name) => [value, name === 'visits' ? 'Visitas' : name === 'uniqueVisitors' ? 'Visitantes Únicos' : 'Visualizações']}
                    />
                    <Legend />
                    <Line type="monotone" dataKey="visits" stroke="#3B82F6" strokeWidth={2} />
                    <Line type="monotone" dataKey="uniqueVisitors" stroke="#8B5CF6" strokeWidth={2} />
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              {/* By Relationship */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Por Relacionamento</h3>
              ...
              {/* By Province */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Por Província</h3>
                <ResponsiveContainer width="100%" height={250}>
              ...
              {/* By Side */}
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Por Lado</h3>
                <ResponsiveContainer width="100%" height={250}>
                  <PieChart>
                    <Pie
        ...
        {activeTab === 'guests' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{analytics.overview.totalGuests}</p>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{analytics.overview.confirmedGuests}</p>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{analytics.overview.pendingGuests}</p>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{analytics.overview.rejectedGuests}</p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Análise Demográfica</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Performance RSVP</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
        ...
        {activeTab === 'engagement' && (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Analytics de Engagement</h3>
        ...
        {activeTab === 'financial' && (
          <div className="space-y-8">
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(analytics.overview.totalBudget)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(analytics.overview.spentAmount)}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(analytics.overview.totalBudget - analytics.overview.spentAmount)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Budget Trend */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Evolução do Orçamento</h3>
              <ResponsiveContainer width="100%" height={400}>
                <AreaChart data={analytics.trends.budgetTrend}>
                  ...
                  <Legend />
                  <Area type="monotone" dataKey="planned" stackId="1" stroke="#3B82F6" fill="#3B82F6" fillOpacity={0.3} name="Planeado" />
                  <Area type="monotone" dataKey="actual" stackId="2" stroke="#10B981" fill="#10B981" fillOpacity={0.6} name="Real" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        {activeTab === 'photos' && (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Analytics de Fotos</h3>
            <p className="text-gray-600">Métricas de galeria e engagement de fotos em desenvolvimento...</p>
          </div>
        )}
        ...
        {activeTab === 'communication' && (
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Analytics de Comunicação</h3>
            <p className="text-gray-600">Métricas de emails, SMS e WhatsApp em desenvolvimento...</p>
          </div>
        )}
      </div>
    </div>
