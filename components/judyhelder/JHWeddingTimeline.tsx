          ...
          <table className="w-full text-left">
            <tbody>
              <tr className="border-b border-gray-200">
                <td className="wedding-text-primary font-fira-sans py-1 pr-2 text-xs sm:text-base">
                  13:00
                </td>
                <td className="wedding-text-primary font-fira-sans py-1 text-xs sm:text-base">
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="wedding-text-primary font-fira-sans flex items-center py-1 text-xs sm:text-base">
